...
def translate(state:ParentState)->dict:
    message = state['Essay']
    prompt = f"Translate the Essay in Hindi, and don't add any extra information, just translate this given Essay \n {message}"
...
parent.add_node('generate_translation',child_workflow)
